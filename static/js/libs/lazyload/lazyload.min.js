...
}("undefined" != typeof global ? global : window || global, function (t) {
	"use strict";
			...
			this.observer = new IntersectionObserver(function (t) {
				t.forEach(function (t) {
					if (t.intersectionRatio > 0) {
						...
						var _s = t.target.getAttribute(e.settings.src),
						    _r = t.target.getAttribute(e.settings.srcset);
						"img" === t.target.tagName.toLowerCase() ? (_s && (t.target.src = _s), _r && (t.target.srcset = _r)) : t.target.style.backgroundImage = "url(" + _s + ")";
					}
				});
